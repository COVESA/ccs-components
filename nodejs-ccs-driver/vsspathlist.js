module.exports = {
    uuidlist: {
        "LeafPaths": [
            ...
            "Vehicle.ADAS.LaneDepartureDetection.Error",
            "Vehicle.ADAS.LaneDepartureDetection.IsActive",
            "Vehicle.ADAS.LaneDepartureDetection.Warning",
            "Vehicle.ADAS.ObstacleDetection.DistanceToObject",
            "Vehicle.ADAS.ObstacleDetection.Error",
            "Vehicle.ADAS.ObstacleDetection.IsActive",
            "Vehicle.ADAS.TCS.Error",
            ...
            "Vehicle.Body.Lights.IsFrontFogOn",
            ...
            "Vehicle.Body.Mirrors.Heating.Status",
            ...
            "Vehicle.Body.Windshield.Heating.Status",
            "Vehicle.Body.Windshield.WasherFluid.Level",
            "Vehicle.Body.Windshield.WasherFluid.LevelLow",
            "Vehicle.Body.Windshield.Wiping.Status",
            ...
            "Vehicle.Cabin.Door.Window.ChildLock",
            ...
            "Vehicle.Cabin.Infotainment.Navigation.CurrentLocation.Accuracy",
            ...
            "Vehicle.Cabin.Lights.Spotlight.IsPassengerOn",
            "Vehicle.Cabin.Lights.Spotlight.IsSharedOn",
            ...
            "Vehicle.Cabin.Seat.Cushion.Height",
            "Vehicle.Cabin.Seat.Cushion.Length",
            "Vehicle.Cabin.Seat.HasPassenger",
            "Vehicle.Cabin.Seat.HeadRestraint.Height",
            "Vehicle.Cabin.Seat.Heating",
            "Vehicle.Cabin.Seat.IsBelted",
            "Vehicle.Cabin.Seat.Lumbar.Height",
            "Vehicle.Cabin.Seat.Lumbar.Inflation",
            "Vehicle.Cabin.Seat.Massage",
            "Vehicle.Cabin.Seat.Position",
            "Vehicle.Cabin.Seat.Recline",
            "Vehicle.Cabin.Seat.SideBolster.Inflation",
            "Vehicle.Cabin.Seat.Switch.Backward",
            "Vehicle.Cabin.Seat.Switch.Cooler",
            "Vehicle.Cabin.Seat.Switch.Cushion.Backward",
            "Vehicle.Cabin.Seat.Switch.Cushion.Down",
            "Vehicle.Cabin.Seat.Switch.Cushion.Forward",
            "Vehicle.Cabin.Seat.Switch.Cushion.Up",
            "Vehicle.Cabin.Seat.Switch.Down",
            "Vehicle.Cabin.Seat.Switch.Forward",
            "Vehicle.Cabin.Seat.Switch.HeadRestraint.Down",
            "Vehicle.Cabin.Seat.Switch.HeadRestraint.Up",
            "Vehicle.Cabin.Seat.Switch.Lumbar.Deflate",
            "Vehicle.Cabin.Seat.Switch.Lumbar.Down",
            "Vehicle.Cabin.Seat.Switch.Lumbar.Inflate",
            "Vehicle.Cabin.Seat.Switch.Lumbar.Up",
            "Vehicle.Cabin.Seat.Switch.Massage.Decrease",
            "Vehicle.Cabin.Seat.Switch.Massage.Increase",
            "Vehicle.Cabin.Seat.Switch.Recline.Backward",
            "Vehicle.Cabin.Seat.Switch.Recline.Forward",
            "Vehicle.Cabin.Seat.Switch.SideBolster.Deflate",
            "Vehicle.Cabin.Seat.Switch.SideBolster.Inflate",
            "Vehicle.Cabin.Seat.Switch.Up",
            "Vehicle.Cabin.Seat.Switch.Warmer",
            "Vehicle.Cabin.SeatPosCount",
            "Vehicle.Cabin.SeatRowCount",
            "Vehicle.Cabin.SteeringWheel.Position",
            ...
            "Vehicle.Chassis.Axle.Wheel.Brake.FluidLevelLow",
            "Vehicle.Chassis.Axle.Wheel.Brake.PadWear",
            "Vehicle.Chassis.Axle.Wheel.Tire.Pressure",
            "Vehicle.Chassis.Axle.Wheel.Tire.PressureLow",
            ...
            "Vehicle.OBD.DriveCycleStatus.MIL",
            ...
            "Vehicle.OBD.O2.Bank2.Sensor1.Voltage",
            "Vehicle.OBD.O2.Bank2.Sensor2.Voltage",
            "Vehicle.OBD.O2.Bank2.Sensor3.Voltage",
            "Vehicle.OBD.O2.Bank2.Sensor4.Voltage",
            ...
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.AccumulatedChargedEnergy",
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.AccumulatedConsumedEnergy",
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.GrossCapacity",
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.NetCapacity",
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.NominalVoltage",
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.ReferentVoltage",
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.StateOfCharge.Displayed",
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.StateOfCharge.Target",
            "Vehicle.Powertrain.EnergyStorage.Battery.Battery.Temperature",
            ...
            "Vehicle.Powertrain.EnergyStorage.FuelSystem.EngineStopStartEnabled",
            "Vehicle.Powertrain.EnergyStorage.FuelSystem.FuelType",
            "Vehicle.Powertrain.EnergyStorage.FuelSystem.HybridType",
            ...
            "Vehicle.Powertrain.EnergyStorage.FuelSystem.TimeSinceStart",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Configuration",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Displacement",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.AmbientAirTemperature",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.ECT",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.EOP",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.EOT",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.MAF",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.MAP",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.Power",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.Speed",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.TPS",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.Engine.Torque",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.FuelType",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.MaxPower",
            "Vehicle.Powertrain.PowerSource.CombustionEngine.MaxTorque",
