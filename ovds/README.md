...
and the binary instance of the VSS tree that can be generated by the binary tool at https://github.com/GENIVI/vehicle_signal_specification.<br>
The path in a request must be found in the VSS tree, if not the request is discarded and a Not found error response is returned. 
